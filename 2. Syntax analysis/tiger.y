...
%union {
    ...
    std::vector<std::unique_ptr<Ty_expre_field>>    *field_expre_list;
...
%type <field_expre_list>    ty_expre_field
...
expre:          INT                                 {$$ = new IntExpre(@1.first_line, @1.first_column, $1);}
            ...
            |   id LBRACE ty_expre_field RBRACE     {$$ = new RecordExpre((@1.first_line, @1.first_column, *$1), std::move((@1.first_line, @1.first_column, *$3))); delete $1;}
            ...
            |   expre AND expre                     {$$ = new IfExp(std::unique_ptr<Expre>(@1.first_line, @1.first_column, $1), std::unique_ptr<Expre>(@1.first_line, @1.first_column, $3), std::unique_ptr<Expre>(new IntExpre(0)));}      
            |   expre OR expre                      {$$ = new IfExp(std::unique_ptr<Expre>(@1.first_line, @1.first_column, $1), std::unique_ptr<Expre>(new IntExpre(1)), std::unique_ptr<Expre>(@1.first_line, @1.first_column, $3));}
            |   expre_opera                         {$$ = $1;}
            |   expre_compa                         {$$ = $1;}
            |   expre_if                            {$$ = $1;}
            |   expre_for                           {$$ = $1;}
...
lvalue:         id                                  {$$ = new SimpleVar(@1.first_line, @1.first_column, *$1); delete $1;}
            |   id LBRACK expre RBRACK              {$$ = new SubscriptVar(llvm::make_unique<SimpleVar>(@1.first_line, @1.first_column, *$1), std::unique_ptr<Expre>(@1.first_line, @1.first_column, $3)); delete $1;}
            |   lvalue DOT id                       {$$ = new FieldVar(std::unique_ptr<Var>(@1.first_line, @1.first_column, $1), (@1.first_line, @1.first_column, $3)); delete $3;}
            |   lvalue LBRACK expre RBRACK          {$$ = new SubscriptVar(std::unique_ptr<Var>(@1.first_line, @1.first_column, $1), std::unique_ptr<Expre>(@1.first_line, @1.first_column, $3));};


ty_expre_field:                                     {$$ = new std::vector<std::unique_ptr<Ty_expre_field>>();}
            |   id EQ expre                         {$$ = new std::vector<std::unique_ptr<Ty_expre_field>>(); $$->push_back(llvm::make_unique<Ty_expre_field>(*$1, std::unique_ptr<Expre>(@1.first_line, @1.first_column, $3))); delete $1;}
            |   id EQ expre COMMA ty_expre_field    {$$ = (@1.first_line, @1.first_column, $5); $5->push_back(llvm::make_unique<Ty_expre_field>((@1.first_line, @1.first_column, *$1), std::unique_ptr<Expre>(@1.first_line, @1.first_column, $3))); delete $1;};
...
expre_if:       IF expre THEN expre                 {$$ = new IfExp(std::unique_ptr<Expre>(@1.first_line, @1.first_column, $2), std::unique_ptr<Expre>(@1.first_line, @1.first_column, $4), NULL);};
            |   expre_if ELSE expre                 {$$ = new IfExp(std::unique_ptr<Expre>(@1.first_line, @1.first_column, $1), std::unique_ptr<Expre>(@1.first_line, @1.first_column, $3));}

expre_for:      FOR id ASSIGN expre TO expre DO expre {$$ = new ForExp((@1.first_line, @1.first_column, *$2), std::unique_ptr<Expre>(@1.first_line, @1.first_column, $4), std::unique_ptr<Expre>(@1.first_line, @1.first_column, $6), std::unique_ptr<Expre>(@1.first_line, @1.first_column, $8)); delete $2;};

expre_while:    WHILE expre DO expre                {$$ = new WhileExp(std::unique_ptr<Expre>(@1.first_line, @1.first_column, $2), std::unique_ptr<Expre>(@1.first_line, @1.first_column, $4));};
...
ty:             id                                  {$$ = new NameType(@1.first_line, @1.first_column, *$1); delete $1;}
            |   LBRACE ty_field_list RBRACE         {$$ = new RecordType(std::move(@1.first_line, @1.first_column, *$2));}
            |   ARRAY OF id                         {$$ = new ArrayType(@1.first_line, @1.first_column, *$3); delete $3;};
